...
export const JA: Record<string, string> = {
  ...
  'Until': '終了',
  'Set it': '作成する',
  'No challenges yet. Set one and the crew has something to chase.':
    'まだチャレンジがありません。作成するとクルーの目標になります。',
  '{target} {unit} · {from} to {to}': '{target}{unit} · {from}〜{to}',
  'Not started': '開始前',
  '{n} days left': '残り{n}日',
  'Finished': '終了',
  'The crew': 'クルー全体',
  '{value} of {target}': '{target}中{value}',
  'Counted from games shared with this crew. A game you keep to yourself does not count.':
    'このクルーに共有したゲームのみ集計されます。共有していないゲームは含まれません。',
  'Delete this challenge': 'このチャレンジを削除',
  'That could not be saved.': '保存できませんでした。',
  'strikes': 'ストライク',
  'spares': 'スペア',
  'games': 'ゲーム',
  'pins': 'ピン',
  ...
  'Next month': '次の月',
  'Show one day': '1日だけ表示',
  'Show everything coming up': '予定をすべて表示',
  'Put a night up': '予定を追加',
  'Put it up': '追加する',
  'What is it': '予定名',
  'League night': 'リーグ戦',
  'Where': '場所',
  'Anything to say about it': 'メモ',
  'Two lanes booked from seven': '19時から2レーン予約',
  'Save the change': '変更を保存',
  'Coming up': '今後の予定',
  'Tonight': '今夜',
  'Nothing on this day.': 'この日は予定がありません。',
  'Nothing arranged yet. Put a night up and the crew can say if they are in.':
    'まだ予定がありません。追加するとクルーが参加を表明できます。',
  'Nobody has said yes yet.': 'まだ誰も参加を表明していません。',
  '{n} coming': '{n}人参加',
  ' · {n} out': ' · 不参加{n}人',
  ' · {n} quiet': ' · 未回答{n}人',
  "I'm in": '参加する',
